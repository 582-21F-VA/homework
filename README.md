...
according to the name of the homework (e.g., "01_conditionals.ts").
...
To submit an assignment, first rename the "index.ts" file to the name of
the homework (e.g., "01_conditionals.ts"), then use GitHub's web
